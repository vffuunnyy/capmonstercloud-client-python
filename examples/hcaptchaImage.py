...
if __name__ == "__main__":
    ...
    metadata = {"Task": "Please click each image containing a mountain"}
    imagesUrls = [
    ...
    # urls example
    request_with_urls = HcaptchaComplexImageTaskRequest(metadata=metadata, imagesUrls=imagesUrls)
    request_with_b64 = HcaptchaComplexImageTaskRequest(metadata=metadata, imagesBase64=imagesBase64)
