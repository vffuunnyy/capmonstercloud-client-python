...
async def solve_captcha_async(num_requests):
    tasks = [
        asyncio.create_task(cap_monster_client.solve_captcha(datadome_request))
...
if __name__ == "__main__":
    ...
    datadome_request = DataDomeCustomTaskProxylessRequest(
        websiteUrl="https://antoinevastel.com/bots/datadome", metadata=metadata
    )
    nums = 3
